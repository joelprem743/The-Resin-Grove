...
export const CATEGORIES: Category[] = [
  {
    ...
    name: "Resin Frames",
    slug: "resin-frames",
    image: "/products/Message Bloom Plaque.jpg",
  ...
  },
  {
    ...
    image: "/products/Alphabet Resin Keychain.jpg",
  ...
  },
  {
    ...
    image: "/products/Luxe Petal Clock.jpg",
  ...
  },
  {
    ...
    image: "/products/Forever Bloom Bouquet.png",
  ...
  },
  {
    ...
    image: "/products/Floral Resin Photo Frame.png",
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewsCount: 56,
    image: "/products/Date & Memory Plaque.png",
    ...
    dimensions: "8\" × 8\"",
    materials: ["Premium Crystal-Clear Resin", "Preserved Dried Flowers", "Gold Foil Accents", "UV-Resistant Resin", "High-Quality Vinyl Printing", "Wooden Display Stand"],
    inStock: true,
    features: ["Fully Personalized Design", "Custom Photo & Calendar Date", "Real Preserved Flowers", "Premium Crystal-Clear Finish", "Handcrafted with Care", "Fade-Resistant & Durable"]
  },
  {
    id: "prod-3",
    ...
    materials: ["Premium Crystal-Clear Resin", "Preserved Dried Flowers", "Gold Foil Accents", "Premium Key Ring", "Gold-Plated Hardware"],
    inStock: true,
    features: ["Personalized Initial Design", "Real Preserved Flowers", "Handcrafted Finish", "Lightweight & Durable", "Scratch-Resistant Surface", "Perfect for Keys & Bags"]
  },
  {
    id: "prod-4",
    ...
    materials: ["Premium Crystal-Clear Resin", "Real Preserved Flowers", "Gold Foil Accents", "High-Quality Photo Print", "UV-Resistant Resin"],
    inStock: true,
    features: ["Personalized Photo Display", "Real Preserved Flowers", "Handcrafted Design", "Crystal-Clear Gloss Finish", "Freestanding Display", "Fade-Resistant & Durable"]
  },
  {
    id: "prod-5",
    ...
    rating: 4.9,
    reviewsCount: 39,
    image: "/products/Velvet Indulgence Bouquet.png",
    ...
    materials: ["Premium Chocolates", "Fresh Roses", "Baby's Breath Flowers", "Premium Bouquet Wrapping", "Satin Ribbon", "Floral Fillers"],
    inStock: true,
    features: ["Handcrafted Floral Arrangement", "Premium Chocolate Selection", "Elegant Gift Wrapping", "Fresh Floral Accents", "Ready to Gift", "Customizable Design"]
  },
  {
    id: "prod-6",
    ...
    rating: 4.9,
    reviewsCount: 95,
    image: "/products/First Year Memories Clock.png",
    isBestSeller: true,
    ...
    materials: ["Premium Crystal-Clear Resin", "High-Quality Photo Prints", "Silent Quartz Clock Movement", "Gold-Finish Clock Hands", "UV-Resistant Resin"],
    inStock: true,
    features: ["12 Monthly Milestone Photos", "Personalized Name & Birth Details", "Silent Quartz Movement", "Handcrafted Premium Finish", "Fade-Resistant & Durable", "Ready to Hang"]
  },
  {
    id: "prod-7",
    ...
    rating: 4.8,
    reviewsCount: 210,
    image: "/products/Photo Bloom Resin Clock.png",
    isBestSeller: true,
    ...
    dimensions: "12\" Diameter",
    materials: ["Premium Crystal-Clear Resin", "Real Preserved Roses", "Gold Foil Accents", "High-Quality Photo Print", "Silent Quartz Clock Movement", "Gold-Finish Clock Hands"],
    inStock: true,
    features: ["Personalized Photo & Names", "Real Preserved Roses", "Silent Quartz Movement", "Handcrafted Premium Finish", "Fade-Resistant & Durable", "Ready to Hang"]
  },
  {
    id: "prod-8",
    ...
    materials: ["Premium Crystal-Clear Resin", "Real Pressed Flowers", "Gold-Tone Alloy Frame", "Gold-Plated Chain", "Protective UV-Resistant Coating"],
    inStock: true,
    features: ["Real Pressed Flowers", "Each Piece is One-of-a-Kind", "Lightweight & Comfortable", "Crystal-Clear Gloss Finish", "Fade-Resistant Resin", "Perfect for Everyday Wear or Gifting"]
  },
  {
    id: "prod-9",
    ...
    rating: 4.6,
    reviewsCount: 119,
    image: "/products/Birth Story Memory Clock.png",
    ...
    dimensions: "12\" Diameter",
    materials: ["Premium Crystal-Clear Resin", "High-Quality Printed Photos", "Gold-Tone Clock Hands", "Silent Quartz Clock Movement", "UV-Resistant Pigments"],
    inStock: true,
    features: ["Personalized with Baby's Name", "12 Monthly Milestone Photos", "Custom Birth Details", "Silent Non-Ticking Movement", "Glossy Crystal-Clear Finish", "Ready to Hang", "Perfect Baby Shower & First Birthday Gift"]
  },
  {
    id: "prod-10",
    ...
    rating: 5.0,
    reviewsCount: 45,
    image: "/products/Rose Keepsake Plaque.png",
    ...
    materials: ["Premium Crystal-Clear Resin", "Preserved Roses", "Baby's Breath Flowers", "Pearl Embellishments", "Gold Foil Accents", "High-Quality Printed Photo"],
    inStock: true,
    features: ["Personalized Photo & Names", "Custom Date Engraving", "Real Preserved Roses", "Handcrafted Floral Design", "Glossy Crystal Finish", "Perfect for Weddings & Anniversaries", "Freestanding Display"]
  },
  {
    id: "prod-11",
    ...
    rating: 4.7,
    reviewsCount: 32,
    image: "/products/Round Resin Name Keychain.png",
    ...
    dimensions: "2\" Round",
    materials: ["Premium Crystal-Clear Resin", "Gold Foil Accents", "Pearl Embellishments", "Metal Keyring & Chain", "High-Quality Vinyl Name"],
    inStock: true,
    features: ["Personalized with Name or Initials", "Handcrafted Design", "Glossy Resin Finish", "Lightweight & Durable", "Scratch-Resistant Surface", "Easy to Attach to Keys or Bags", "Perfect for Gifting"]
  },
  {
    id: "prod-12",
    ...
    rating: 5.0,
    reviewsCount: 155,
    image: "/products/Signature Calendar Plaque.jpg",
    isBestSeller: true,
    ...
    dimensions: "8\" Round Plaque",
    materials: ["Premium Crystal-Clear Resin", "High-Quality Printed Photo", "Decorative Pearl Embellishments", "Silver Glitter Accents", "UV-Resistant Pigments"],
    inStock: true,
    features: ["Personalized Photo", "Custom Calendar Date", "Names & Custom Message", "Handcrafted Design", "Glossy Crystal Finish", "Freestanding Display", "Perfect for Birthdays, Anniversaries & Special Occasions"]
  },
  {
    id: "prod-13",
    ...
    rating: 5.0,
    reviewsCount: 155,
    image: "/products/Floral Resin Wall Clock.png",
    isBestSeller: true,
    ...
    dimensions: "12\" Diameter",
    materials: ["Premium Crystal-Clear Resin", "Preserved Rose Petals", "Baby's Breath Flowers", "Pearl Embellishments", "Gold Foil Accents", "Silent Quartz Clock Movement", "Gold-Tone Clock Hands"],
    inStock: true,
    features: ["Handcrafted Floral Design", "Silent Non-Ticking Movement", "Elegant Roman Numerals", "Glossy Crystal Finish", "Wall-Mount Ready", "Lightweight & Durable", "Perfect for Home & Gift Decor"]
  }
];
...
export const INSTAGRAM_IMAGES = [
  { id: "ig-1", url: "https://images.unsplash.com/photo-1610701596007-11502861dcfa?auto=format&fit=crop&w=400&h=400&q=80", likes: "2.4k", comments: "84" },
  { id: "ig-2", url: "https://images.unsplash.com/photo-1603006905003-be475563bc59?auto=format&fit=crop&w=400&h=400&q=80", likes: "1.8k", comments: "49" },
  { id: "ig-3", url: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=400&h=400&q=80", likes: "4.1k", comments: "156" },
  { id: "ig-4", url: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?auto=format&fit=crop&w=400&h=400&q=80", likes: "3.2k", comments: "92" },
  { id: "ig-5", url: "https://images.unsplash.com/photo-1621259182978-f09e5122ae8e?auto=format&fit=crop&w=400&h=400&q=80", likes: "1.5k", comments: "38" },
  { id: "ig-6", url: "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=400&h=400&q=80", likes: "2.9k", comments: "73" }
];
